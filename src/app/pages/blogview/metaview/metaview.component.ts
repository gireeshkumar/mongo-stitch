...
import {MetaviewService} from './metaview.service';

@Component({
  selector: 'metaview',
  templateUrl: './metaview.html',
  styleUrls: ['./metaview.scss']
})
export class MetaView {
  ...
  constructor(private _baConfig:BaThemeConfigProvider, private _todoService:MetaviewService) {
